...
public class ObjectFactory {
    ...
    private final static QName _Root_QNAME = new QName("http://calculator.me.org/", "root");
    private final static QName _MulResponse_QNAME = new QName("http://calculator.me.org/", "mulResponse");
    private final static QName _Mul_QNAME = new QName("http://calculator.me.org/", "mul");
    private final static QName _PrimeResponse_QNAME = new QName("http://calculator.me.org/", "primeResponse");
    private final static QName _DivResponse_QNAME = new QName("http://calculator.me.org/", "divResponse");
    private final static QName _RootResponse_QNAME = new QName("http://calculator.me.org/", "rootResponse");
    private final static QName _Add_QNAME = new QName("http://calculator.me.org/", "add");
    private final static QName _Div_QNAME = new QName("http://calculator.me.org/", "div");
    private final static QName _Prime_QNAME = new QName("http://calculator.me.org/", "prime");
    private final static QName _Sub_QNAME = new QName("http://calculator.me.org/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://calculator.me.org/", "subResponse");
    ...
    /**
     * Create an instance of {@link RootResponse }
     * 
     */
    public RootResponse createRootResponse() {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "root")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "mul")
    public JAXBElement<Mul> createMul(Mul value) {
        return new JAXBElement<Mul>(_Mul_QNAME, Mul.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PrimeResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "primeResponse")
    public JAXBElement<PrimeResponse> createPrimeResponse(PrimeResponse value) {
        return new JAXBElement<PrimeResponse>(_PrimeResponse_QNAME, PrimeResponse.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "divResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RootResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "rootResponse")
    public JAXBElement<RootResponse> createRootResponse(RootResponse value) {
        return new JAXBElement<RootResponse>(_RootResponse_QNAME, RootResponse.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "div")
    public JAXBElement<Div> createDiv(Div value) {
        return new JAXBElement<Div>(_Div_QNAME, Div.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Prime }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "prime")
    public JAXBElement<Prime> createPrime(Prime value) {
        return new JAXBElement<Prime>(_Prime_QNAME, Prime.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator.me.org/", name = "subResponse")
