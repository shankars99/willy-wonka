...
{
    FILE *inp = fopen("../exe/3DES/input/input.txt", "rb");
    out = fopen("../exe/3DES/temp/1.txt", "wb+");
    char ch;
...
int bittochar()
{
    out = fopen("../exe/3DES/output/result.txt", "ab+");
...
{
    out = fopen("../exe/3DES/temp/2.txt", "ab+");
    for (int i = 0; i < 64; i++)
...
{
    out = fopen("../exe/3DES/temp/1.txt", "ab+");
    for (int i = 0; i < 64; i++)
        initialPermutation(i, plain[i]);
...
void decrypt(long int n, char *str)
{
    ...
    FILE *out = fopen("../exe/3DES/temp/1.txt", "wb+");
    fclose(out);

    out = fopen("../exe/3DES/output/result.txt", "wb+");
    fclose(out);
...
void encrypt(long int n, char *str)
{
    ...
    FILE *out = fopen("../exe/3DES/temp/2.txt", "wb+");
    fclose(out);
...
{
    FILE *pt = fopen("../exe/3DES/input/key.txt", "rb");
...
int main()
{
    ...
    key64to48(key);
    encrypt(n, "../exe/3DES/temp/1.txt"); // convert ../exe/3DES/temp/1.txt to ../exe/3DES/temp/2.txt using K1

    key64to48(key + 64);
    decrypt(n, "../exe/3DES/temp/2.txt"); // convert ../exe/3DES/temp/2.txt to ../exe/3DES/temp/1.txt using K2

    key64to48(key + 128);
    encrypt(n, "../exe/3DES/temp/1.txt"); // convert ../exe/3DES/temp/1.txt to ../exe/3DES/temp/2.txt using K3

    // Decryption starts (reverse of Encryption)
    // decrypt with K3, encrypt with K2, then decrypt with K1.

    key64to48(key + 128);
    decrypt(n, "../exe/3DES/temp/2.txt"); // convert ../exe/3DES/temp/2.txt to ../exe/3DES/temp/1.txt using K3

    key64to48(key + 64);
    encrypt(n, "../exe/3DES/temp/1.txt"); // convert ../exe/3DES/temp/1.txt to ../exe/3DES/temp/2.txt using K2

    key64to48(key);
    decrypt(n, "../exe/3DES/temp/2.txt"); // convert ../exe/3DES/temp/2.txt to ../exe/3DES/temp/1.txt using K1
